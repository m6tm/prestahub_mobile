  ...
  Future<void> onError(DioException err, ErrorInterceptorHandler handler) async {
    ...
    if (_isNetworkError(err)) {
      ...
      if (['POST', 'PUT', 'PATCH', 'DELETE'].contains(method)) {
        ...
        _logger.w("SyncInterceptor: Échec réseau détecté pour ${err.requestOptions.path}. Mise en file d'attente.");
        ...
        try {
          final syncReq = SyncRequest(
            ...
            data: err.requestOptions.data is Map<String, dynamic> 
                ...
                : null,
            queryParameters: Map<String, dynamic>.from(err.requestOptions.queryParameters),
          ...
          _logger.e("SyncInterceptor: Erreur lors de l'ajout à la file de synchro: $e");
        }
      }
    }
